...
def isolated_branding_globals():
    ...
    keys = ["site_name", "site_icon", "site_icon_color_light", "site_icon_color_dark", "logo_mode", "logo_light_path", "logo_dark_path", "theme_color", "theme_accent_light", "theme_accent_dark", "theme_surface_light", "theme_surface_dark", "theme_border_light", "theme_border_dark"]
